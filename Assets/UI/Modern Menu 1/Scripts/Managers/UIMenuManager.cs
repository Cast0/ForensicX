...
namespace SlimUI.ModernMenu{
	public class UIMenuManager : MonoBehaviour {
		...
		IEnumerator LoadAsynchronously(string morgue){ // scene name is just the name of the current scene being loaded
			AsyncOperation operation = SceneManager.LoadSceneAsync(morgue);
